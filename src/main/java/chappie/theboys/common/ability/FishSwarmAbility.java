...
public class FishSwarmAbility extends Ability implements IHasTimer {
    ...
    private final Timer timer = new Timer(() -> 10, this::isEnabled);
    ...
    public void initializeClient(Consumer<AbilityClientProperties> consumer) {
        ...
        consumer.accept(new AbilityClientProperties() {
            ...
            private void applyFullSurfingAnimation(HumanoidModel<?> model, float ageInTicks,
            ...
            private void applyArmBalance(HumanoidModel<?> model, float ageInTicks, float speedFactor) {
                // arm balancing speed
            ...
            private void applyLegBalance(HumanoidModel<?> model, float ageInTicks, float speedFactor, boolean isCrouching) {
                float legSpeed = 0.1f;
