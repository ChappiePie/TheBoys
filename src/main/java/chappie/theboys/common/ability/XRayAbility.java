...
public class XRayAbility extends Ability {
    ...
    public void update(LivingEntity entity, boolean enabled) {
        ...
        if (this.entity.level().isClientSide() && FMLEnvironment.dist == Dist.CLIENT) {
            if (this.hitPos != null) {
                ...
                if (!this.translucentTimer.ended() || (lastAABB == null || (int) lastAABB.minX != minX || (int) lastAABB.minY != minY || (int) lastAABB.minZ != minZ ||
                        (int) lastAABB.maxX != maxX || (int) lastAABB.maxY != maxY || (int) lastAABB.maxZ != maxZ)) {

                    if (lastAABB != null) {
                        Minecraft.getInstance().levelRenderer.setBlocksDirty(
                                (int) lastAABB.minX, (int) lastAABB.minY, (int) lastAABB.minZ,
                                (int) lastAABB.maxX, (int) lastAABB.maxY, (int) lastAABB.maxZ);
                    }
