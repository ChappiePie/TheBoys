 ...
 public class TrailRenderer extends EntityRenderer<TrailEntity, TrailRenderState> {
    ...
    public void render(TrailRenderState renderState, PoseStack poseStack, MultiBufferSource bufferSource, int packedLight) {
        ...
        renderState.trail.model().renderToBuffer(poseStack, bufferSource.getBuffer(RenderType.entityTranslucent(renderState.trail.texture())), packedLight, OverlayTexture.NO_OVERLAY, ARGB.color((int) (alpha * 255), (int) (red * 255), (int) (green * 255), (int) (blue * 255)));
        poseStack.popPose();
